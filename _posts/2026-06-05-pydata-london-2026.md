...
- LLMs are deep neural networks
  ...
  - Fine-tuning a model: Adjust parameters of a pre-trained model in order to make it better suited for a given task
    - Fine-tuning from examples that are human-curated (and therefore expensive to create)
    - Preference learning from ratings provided by humans while using chatbots
  - 
